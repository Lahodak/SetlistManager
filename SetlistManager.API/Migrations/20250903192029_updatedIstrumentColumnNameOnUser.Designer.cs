...
namespace SetlistManager.API.Migrations
{
    ...
    [Migration("20250903192029_updatedIstrumentColumnNameOnUser")]
    partial class updatedIstrumentColumnNameOnUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SetlistManager.API.Data.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SetlistManager.API.Data.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SetlistManager.API.Data.Entities.User", b =>
                {
                    b.HasOne("SetlistManager.API.Data.Entities.Instrument", "Instrument")
                        .WithMany("Users")
